...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "edge-tts voice name for the target language. "
            "Run 'edge-tts --list-voices' and filter by language code "
            "(e.g. zh-CN, fr-FR, de-DE, ja-JP, es-MX) to find the right voice."
        ),
    )
    parser.add_argument(
